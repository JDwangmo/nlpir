...
print curDir
libFile = curDir + '/nlpir/libNLPIR64.so'
...
# curDir is the dir of /data/
if not Init(curDir,ENCODING.UTF8_CODE,''):
...
if __name__ == "__main__":
    p = "Big News: @解放日报 [最右]【呼市铁路局原副局长被判死缓 最头痛藏钱】2013年12月底，呼市铁路局原副局长马俊飞因受贿被判死缓。他说最头痛藏钱，从呼和浩特到北京，" \
		"马俊飞又是购房又是租房，在挥之不去的恐惧中，人民币8800万、美元419万、欧元30万、港币27万，黄金43.3公斤，逐渐堆满了两所房子…… http://t.cn/8kgR6Yi"
    for t in Seg(p):
